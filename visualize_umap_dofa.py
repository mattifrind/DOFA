...
def load_dofa_features(feature_file: str, label_file: str) -> Tuple[np.ndarray, np.ndarray]:
...
def main():
    ...
    parser.add_argument("features", type=str, help="Torch file")
    parser.add_argument("labels", type=str, help="Torch file")
    parser.add_argument("output", type=str, help="Output file name without extension")
    parser.add_argument("--show", action="store_true", help="Show the plot")
    args = parser.parse_args()

    print("Loading features...")
    X, Y_43 = load_dofa_features(args.features, args.labels)
    Y_19 = convert_labels(np.array(Y_43))
